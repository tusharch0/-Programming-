...
ownerq = ["who made you", "who is you owner",
          "who is your head", "to whom you belong"]
ownera = ["My lord", "My lord is your friend", "Your friend",
          "He is like you only", "A person like you"]

laughq = ["laugh", "joke"]
laugha = ["Did you hear about the blind carpenter who picked up his hammer and saw?", "A teacher is talking to a student.Teacher: Did your father help you with your homework? Student: No, he did it all by himself.",
...
def check_for_greeting(sentence):
    ...
    for i in range(0, 5):
        if moodq[i] in sentence:
            print(random.choice(moodr), " ",
                  "It would be great to have a conversation with you")
            speaking = random.choice(
                moodr) + " " + "It would be great to have a conversation with you"
            speak(data)
    ...
    if sentence == "sing a song":
        ...
        if "hindi" in j:
            ...
            print("Search it on google", "\r",
                  "I know about only english, hindi, punjabi")
